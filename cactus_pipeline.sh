...
cactus-minigraph ./jobstore_$2 $1 $2.gfa --reference $3

# creating paf map (assembly-to-graph alignments)
cactus-graphmap ./jobstore_$2 $1 $2.gfa $2.paf  --reference $3 --outputFasta $2.sv.gfa.fa.gz

# creating hal (cactus base alignment)
cactus-align ./jobstore_$2 $1 $2.paf $2.hal --pangenome --outVG --reference $3 
